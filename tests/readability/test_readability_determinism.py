...
class DeterministicReadabilityEvaluator:
...
def test_readability_agent_deterministic_same_input():
    """Prüft, dass gleicher Input + gleiche Config identischen Output liefert."""
    evaluator = DeterministicReadabilityEvaluator(seed=42)
...
def test_readability_agent_deterministic_different_input():
