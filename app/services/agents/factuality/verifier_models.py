...
class EvidenceSelection:
    ...
    quote: Optional[str]  # None wenn keine Evidence, sonst wörtlicher Quote
    passage: Optional[str]  # None wenn keine Passage, sonst die ausgewählte Passage
    ...
    reason: str  # ok | no_passage_selected | index_out_of_range | empty_quote | quote_not_in_passage
