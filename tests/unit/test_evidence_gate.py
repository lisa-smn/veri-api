...
class TestEvidenceGate:
    ...
    def test_incorrect_without_evidence_becomes_uncertain(self):
        ...
        fake_llm.set_response(
            '{"label": "incorrect", "confidence": 0.8, "error_type": "NUMBER", "explanation": "Zahl falsch", "evidence": []}'
        )
    ...
    def test_incorrect_with_evidence_stays_incorrect(self):
        ...
        fake_llm = FakeLLMClient()
        fake_llm.set_response(
            '{"label": "incorrect", "confidence": 0.9, "error_type": "NUMBER", "explanation": "Zahl falsch", "evidence": ["Der Artikel enthält die Zahl 100."]}'
        )
    ...
    def test_evidence_spans_structured(self):
        ...
        fake_llm = FakeLLMClient()
        fake_llm.set_response(
            '{"label": "correct", "confidence": 0.9, "explanation": "Korrekt", "evidence": ["Der Artikel enthält die Zahl 100."]}'
        )
